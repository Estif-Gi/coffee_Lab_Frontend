...
function LoginPage() {
  ...
  const login = useCoffeeStore((state) => state.login)
    ...
    <main className="min-h-screen bg-transparent">
      ...
      <section className="mx-auto max-w-xl px-4 py-16 md:px-8">
        <div className="luxury-surface rounded-3xl border border-beige/60 bg-white/90 p-10 shadow-xl dark:border-coffee-700 dark:bg-coffee-950/90">
          <h1 className="mb-4 text-3xl font-semibold text-coffee-900 dark:text-cream">Login</h1>
          <p className="mb-8 text-sm text-coffee-700 dark:text-beige">Access your Coffee Lab account to manage events, menu items, and promotions.</p>
          ...
          <p className="mt-6 text-sm text-coffee-700 dark:text-beige">
            ...
            <Link to="/signup" className="font-semibold text-coffee-900 underline dark:text-cream">
              Sign up
            </Link>
          </p>
        </div>
